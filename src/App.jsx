...
function App() {
  ...
  const convert = () => {
    setResult(amount * currencyInfo[toValue]);
  };
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1666384781147-d3cd8830dbd4?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
      }}
    >
